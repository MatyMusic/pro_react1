...
function InputEX(props) {
    ...
    return (
        <div className='col-md-6 mx-auto border  input'>
            <div className='text-center'>
                <h1 className='my-12'>Currency Converter</h1>
                <hr />
            </div>
            <h3 className='text-center mb-3 mt-4 color-silver'>Choose currency</h3>
            <select id='idfirst' onChange={calcTotal} ref={firstValueRef} className='bg-info form-control select1 mb-3 text-center '>
            ...
            <button className="a mb-5" onClick={changeClick}></button>
            <select onChange={calcTotal} ref={endlValueRef} className='bg-danger form-control select2 mb-5 text-center'>
                <option value="USD">USD U.S. Dollar</option>
                <option value="ILS">ILS New Shekel</option>
                <option value="EUR">EURO</option>
                <option value="BTC">BTC Bitcoin</option>
            ...
            <h3 className='text-center mb-3'>Amount</h3>
            <input onInput={calcTotal} ref={amountRef} type="number" defaultValue="100" className='bg-success form-control text-center' />
        </div>
    )
}
